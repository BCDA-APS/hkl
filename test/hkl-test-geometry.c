...
HKL_TEST_SUITE_FUNC(update)
{
	...
	HKL_ASSERT_DOUBLES_EQUAL(1./sqrt(2), g->holders[0]->q.a, HKL_EPSILON);
...
HKL_TEST_SUITE_FUNC(distance)
{
	...
	HklGeometry *g2 = NULL;
	HklHolder *holder = NULL;
	double values_1[] = {0., 0., 0.};
	double values_2[] = {1., 1., 1.};
...
HKL_TEST_SUITE_FUNC(list)
{
	...
	HklHolder *holder;
	double values[] = {0., 0., 0.};
	double values_1[] = {30. * HKL_DEGTORAD, 0., 0.};
	double values_2[] = {10. * HKL_DEGTORAD, 0., 0.};
...
HKL_TEST_SUITE_FUNC( list_multiply_from_range )
{
	...
	double values[] = {185. * HKL_DEGTORAD, -185. * HKL_DEGTORAD, 190. * HKL_DEGTORAD};
